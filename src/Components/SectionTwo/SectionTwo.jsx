    ...
    <div className="section-two">
      ...
      <div className="features">
        <div className="feature">
          <h3><FaCogs className="icon" /> Lack of customization...</h3> {/* Icon with class */}
          <p>You're unable to customize or extend the CMS to fit your unique project needs.</p>
        </div>
        <div className="feature">
          <h3><FaPlug className="icon" /> Lack of plugins...</h3> {/* Icon with class */}
          <p>You are not able to use your favorite tools, and lack plugins or integrations.</p>
        </div>
        <div className="feature">
          <h3><FaUsers className="icon" /> Lack of community...</h3> {/* Icon with class */}
